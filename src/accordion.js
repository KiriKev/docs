    ...
    details: [
      {
        ...
        answer:
          'LUKSO introduced new blockchain standards to address issues with existing Ethereum Requests for Comments (ERCs), such as token/NFT approval security, limited metadata, lack of interoperability (ERC677, ERC777 and ERC1155 use each different callback hook functions to notify on token transfer), and requiring users to acquire native token upfront to pay for transaction fees (gas). LSP standards include features like <a href="/standards/accounts/lsp1-universal-receiver">universalReceiver</a> for notifications, <a href="/standards/erc725">flexible metadata</a>, <a href="/standards/access-control/lsp6-key-manager">secure permissions management</a>, and <a href="/standards/accounts/lsp25-execute-relay-call">gasless transactions</a> for easier user onboarding.',
